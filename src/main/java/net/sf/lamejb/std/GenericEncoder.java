...
/**
 * This interface may be used to progressively encode a PCM stream to MP3.
 *
 ...
 * only raw PCM is supposed. Call the {@link #getLameConfig()} method
 ...
 *
 * @see LameEncoderFactory#createGenericEncoder()
 */
